  ...
  <div className="row m-0">
   ...
   <img src={firstImg}/>
        ...
        <h4 className="pt-4 m-0">E-Commerce Solutions</h4>
          <div className="pt-4 text-center pl-2 pr-2 cl-8585858">We provide extensive E-commerce 
solution along with 24/7 help and support 
in any regard.</div>
<div className="pt-5"><button type="button" class="btn btn-light bg-269da1 cl-ffffff button_1 d-flex  justify-content-center justify-center align-items-center "><img src={arrow}/>&nbsp;&nbsp;Read More</button></div>
        </section>
   </div>
      </div>
  ...
  <h4 className="pt-4 m-0">Web Application</h4>
          ...
          We have a dedicated and hardworking 
team of web designers to help our valued 
customers in any way they want.
</div>
<div className="pt-5"><button type="button" class="btn btn-light bg-269da1 cl-ffffff button_1 d-flex  justify-content-center justify-center align-items-center "><img src={arrow}/>&nbsp;&nbsp;Read More</button></div>
  </section>
    </div>
...
<h4 className="pt-4 m-0">Design Service</h4>
          <div className="pt-4 text-center pl-2 pr-2 cl-8585858">
          Our graphic designing team is expert in 
making Creative and User Experience-based 
Design that gives visual representation 
to your brand.
</div>
<div className="pt-4"><button type="button" class="btn btn-light bg-269da1 cl-ffffff button_1 d-flex  justify-content-center justify-center align-items-center "><img src={arrow}/>&nbsp;&nbsp;Read More</button></div>
</section>
   </div>
      </div>
  </div>
